 ...
 */
public class CustomSwiperAdapterGuj extends RecyclerView.Adapter<CustomSwiperAdapterGuj.RecyclerViewHolder> {
    ...
    public CustomSwiperAdapterGuj(Context ctx, List<addNews> addnews)
    {
        this.ctx = ctx;
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, final int position) {
        ...
        switch (viewType) {
            ...
            default:
                ...
                holder.newsTitle.setText(addnews.get(position).getTitle_guj());
                holder.newsDescription.setText(addnews.get(position).getDescription_guj());
